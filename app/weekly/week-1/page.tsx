    ...
    <div className="min-h-screen bg-[#0E4F33] text-white">
      <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        <div className="mt-8 space-y-4 rounded-2xl border border-white/10 bg-black/20 p-6 text-white/80">
          <p>• Big matches to watch: pick 2-3 fixtures you care about and add them here.</p>
          <p>• Standings pressure: who can jump positions this round?</p>
          <p>• Notes: injuries, rivalries, derby games, etc.</p>
        </div>
      </div>
    </div>
  );
